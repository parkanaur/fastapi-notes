...
\lstnewenvironment{code}[1]{\lstset{language=#1, style=cstyle}}{}
\newcommand{\cinline}[2]{{\lstinline[language=#1, style=cstyle, basicstyle=\ttfamily\normalsize]{#2}}}

% Python code listings
\lstnewenvironment{pycode}{\lstset{language=Python, style=cstyle, morekeywords={async}}}{}
\newcommand{\pyinline}[1]{\lstinline[language=Python, style=cstyle, morekeywords={async}, basicstyle=\ttfamily\normalsize]{#1}}

% Bash code listings
\lstnewenvironment{bashcode}{\lstset{language=bash, style=cstyle, morekeywords={poetry, git, mv, python, uvicorn}}}{}
