...
\lstnewenvironment{code}[2][]{\lstset{language=#1, caption=#2, style=cstyle}}{}
\newcommand{\cinline}[2]{{\lstinline[language=#1, style=cstyle, basicstyle=\ttfamily\normalsize]{#2}}}

% Python code listings
\lstnewenvironment{pycode}[1][]{\lstset{language=Python, caption=#1, style=cstyle, morekeywords={async}}}{}
\newcommand{\pyinline}[1]{\lstinline[language=Python, style=cstyle, morekeywords={async}, basicstyle=\ttfamily\normalsize]{#1}}

% Bash code listings
\lstnewenvironment{bashcode}[1][]{\lstset{language=bash, caption=#1, style=cstyle, morekeywords={docker, poetry, git, mv, python, uvicorn}}}{}
...
\begin{pycode}[\texttt{pyfh/config.py}]
