...
\lstdefinelanguage{docker}{
    ...
    image, environment, ports, container\_name, ports, links, env\_file, depends\_on, build, version, volumes, services, networks},
    keywordstyle=\color{blue}\bfseries,
...
\begin{enumerate}
    \item{
            ...
            Assume the port mapping \texttt{"8000:80"}, as described in Figure \ref{preparations:dockerports}.

            \begin{figure}[h]
                \centering
                \includegraphics[width=0.55555\textwidth]{img/docker_ports.png}
